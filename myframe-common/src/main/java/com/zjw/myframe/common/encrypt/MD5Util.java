package com.zjw.myframe.common.encrypt;
...
public class MD5Util {
    /*
     * A Java implementation of the RSA Data Security, Inc. MD5Util Message Digest
    ...
    public static String passwordEncode(String password, String salt){
        ...
        if(salt != null){
            result = md5Util.calcMD5(md5Util.calcMD5(password) + salt);
        }else{
            result = md5Util.calcMD5(password);
        }
    ...
    public static String tokenEncode(String token){
        ...
        MD5Util md5Util = new MD5Util();
        String result = md5Util.calcMD5(token);
        return result.toUpperCase();
    }
